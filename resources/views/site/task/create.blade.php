...
<div id="formulario" >
  <form action="{{route('site.task.novoconfirma')}}" method="POST" class="form" enctype="multipart/form-data" id="FRMF7A48BC4E7638ACFAD04D740A04C2D86">
  @csrf      
  <fieldset>
    ...
    <div class="campo  larg_10" >
      ...
      <span class="controle"><input type="date" name="dtinicio" id="dtinicio"value="" autocomplete="off" /></span>
    </div>
    <div class="campo  larg_10" >
      <span class="etiqueta" id="dtentrega_lb" >Due Date</span>
      <span class="controle"><input type="date" name="dtentrega" id="dtentrega"value="" autocomplete="off" /></span>
    </div>
    ...
    <div class="campo  larg_100" >
      ...
      <span class="controle"><input name="tarefa" type="text" id="tarefa" value="New Task"  maxlength=100 /></span>
    </div>
    <div class="campo  larg_100" >
      <span class="etiqueta" id="instrucao_lb" >Instructions</span>
      <span class="controle"><textarea class=normal name="instrucao" id="instrucao" rows=10 width=100% ></textarea></span>
     </div>
  </fieldset>
  <div class=botoeira>
    <button type="button" name="cancelar" class=cancelar value="Cancelar" onclick="location.href='{{route('site.action.ficha',$action->token)}}'">Cancel</button>
